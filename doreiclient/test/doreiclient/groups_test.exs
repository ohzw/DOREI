defmodule Doreiclient.GroupsTest do
  ...
  describe "groups" do
    ...
    @valid_attrs %{leader: "some leader", name: "some name"}
    @update_attrs %{leader: "some updated leader", name: "some updated name"}
    @invalid_attrs %{leader: nil, name: nil}
    ...
    test "create_group/1 with valid data creates a group" do
      ...
      assert group.leader == "some leader"
    ...
    test "update_group/2 with valid data updates the group" do
      ...
      assert group.leader == "some updated leader"
